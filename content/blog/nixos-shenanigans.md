...
over the past few days whilst i have been working on this site, i have also been toying around with [NixOS](https://nixos.org/) and the Nix language, mainly out of my own fustrations with other more traditional Linux distributions and the way they handle packaging and system configuration. it's like they're rigged to blow at a random point in time and i just have to pray that i am lucky enough to not have it blow before i start distrohopping again, lol... 
